...
export default function About () {
    ...
    return (
        ...
        <section className="min-h-screen bg-[#e6eeff] dark:bg-[#020617] flex items-center py-10 px-6 md:px-16"
            id="about"
            >
            <div className="max-w-6xl mx-auto w-full grid gap-8 md:grid-cols-2">
                ...
                <Motion.motion.div 
                    ...
                    className="bg-[#0e1c38]/80 dark:bg-[#0e1c38]/80 backdrop-blur-3xl rounded-3xl p-8 shadow-2xl"
                    >
                ...
                <Motion.motion.div 
                    ...
                    className="bg-[#0e1c38]/80 dark:bg-[#0e1c38]/80 backdrop-blur-xl rounded-3xl p-8 shadow-2xl"
                    >
                    <h2 className="text-3xl font-bold text-white mb-6">
                        Skills
                    </h2>
