...
export default function NavBar () {
    ...
    return (
        <Motion.motion.header
            ...
            className="fixed top-0 left-0 z-50 w-full md:px-16 py-5 flex 
                items-center justify-between bg-[#e6eeff]/80 backdrop-blur-md text-[#020617] 
                shadow-xl dark:bg-[#0e1c38] dark:text-gray-200"
                >
            ...
            <div className="flex items-center gap-4">
                ...
                <button
                    ...
                    className="md:inline-flex bg-blue-600 text-white px-5 py-2 
            ...
            <div
            className={`absolute top-full left-0 z-50 w-full bg-[#e6eeff] text-gray-800 dark:bg-[#0e1c38] dark:text-gray-200
